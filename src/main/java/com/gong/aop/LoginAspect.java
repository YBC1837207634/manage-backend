...
public class LoginAspect {
     ...
     * 后置通知
     */
    @AfterReturning(value = "execution(* com.gong.controller.LoginController.login(*))", returning = "result")
     ...
     * 后置异常通知
     */
    @AfterThrowing(value = "execution(* com.gong.controller.LoginController.login(*))", throwing = "ex")
