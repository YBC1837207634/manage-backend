...
public class CodeGenUtils {
    ...
    public static VelocityContext createVelocityContext(String tableName, String field, String type, String url, String viewName, Boolean isExport, Boolean isPage) {
        String entityName = CamelCaseUtils.convertToCamelCase(tableName);
        // 初始化表的元数据
        ...
        context.put("fieldCamel", CamelCaseUtils.convertToCamelCase(field));  //进行查询或者用于更新的字段名
        context.put("fieldSmallCamel", CamelCaseUtils.convertToSmallCamelCase(field));
